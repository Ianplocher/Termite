    ...
    <section className="relative text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 25% 25%, #309C42 1px, transparent 1px), radial-gradient(circle at 75% 75%, #309C42 1px, transparent 1px)",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-balance drop-shadow-lg">
            ...
            <span className="text-lime drop-shadow-md">Riverside, CA</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-200 mb-8 text-balance drop-shadow-sm">
